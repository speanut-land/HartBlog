...
class Observable {
    ...
    subscribe(observer) {
        ...
        if (typeof observer === "function") {
            return this._subscribe(Object.assign(Object.assign({}, defaultObserver), { next: observer }));
        }
        else {
            return this._subscribe(Object.assign(Object.assign({}, defaultObserver), observer));
        }
    }
}
exports.Observable = Observable;
function map(fn) {
    return (observer) => new Observable((observer) => {
        observer.subscribe({
